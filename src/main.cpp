...
private:
    ...
    void initWindow() {
        ...
        glfwSetFramebufferSizeCallback(window, handleFramebufferResizedCallback);
    }

    static void handleFramebufferResizedCallback(GLFWwindow* window, int width, int height){
    ...
    void createInstance() {
        ...
        appInfo.applicationVersion = VK_MAKE_API_VERSION(0, GAME_VERSION_MAJOR, GAME_VERSION_MINOR, 0);
        appInfo.pEngineName = "Mad's Engine";
        appInfo.engineVersion = VK_MAKE_VERSION(ENGINE_VERSION_MAJOR, ENGINE_VERSION_MAJOR, 0);
    ...
    void createGraphicsPipeline() {
        ...
        vertShaderStageInfo.module = sharedShaderModule;
        vertShaderStageInfo.pName = "vertexMain";

        VkPipelineShaderStageCreateInfo fragShaderStageInfo{};
        fragShaderStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
        fragShaderStageInfo.stage = VK_SHADER_STAGE_FRAGMENT_BIT;
        fragShaderStageInfo.module = sharedShaderModule;
        ...
        vkDestroyShaderModule(device, sharedShaderModule, nullptr);
    }
    ...
    void drawFrame() {
        int32_t frameIndex = currentFrame %MAX_FRAMES_IN_FLIGHT;
